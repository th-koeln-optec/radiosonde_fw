...
/*nirq*/
#define GPIO_RADIO_NRIQ GPIOB
#define GPIO_CRL_MODE_RADIO_NRIQ_Pos GPIO_CRL_MODE0_Pos
#define GPIO_CRL_MODE_RADIO_NRIQ_Msk GPIO_CRL_MODE0_Msk
#define GPIO_CRL_CNF_RADIO_NRIQ_Msk GPIO_CRL_CNF0_Msk
#define GPIO_CRL_CNF_RADIO_NRIQ_Pos GPIO_CRL_CNF0_Pos
/*gpio3*/
