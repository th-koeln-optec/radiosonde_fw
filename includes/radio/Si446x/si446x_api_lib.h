/// @file si446x_spi_lib.h
/*
 * Filename:            si446x_spi_lib.h
 * Description:         This file contains the Si446x API library.
 * Author:              Copyright 2011 Silicon Laboratories, Inc.
 * Edited by:           M. Malyska; The original file can be found in the same directory: si446x_api_lib.h.bak
 */
...
/*MALYSKA:These data types are not compatile with the stdint.h convention used here, so a redefinition was chosen to solve this.*/
#define U8 uint8_t
#define U16 uint16_t
#define S16 int16_t
#define U32 uint32_t
...
/*Malyska: These includes are necessary for the platform used.*/
#include <stdarg.h>
#include <stdint.h>
...
/*Malyska: These variable definitions are not compatible with the platform used!
