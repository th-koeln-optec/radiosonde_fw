/// @file si446x_spi_lib.c
/*
 * Filename:            si446x_spi_lib.c
 * Description:         This file contains the Si446x API library.
 * Author:              Copyright 2011 Silicon Laboratories, Inc.
 * Edited by:           M. Malyska; The original file can be found in the same directory: si446x_api_lib.c.bak
 */
...
/*Malyska: This include is not needed on the platform used
#include "..\..\..\bsp.h"
*/
...
U8 si446x_configuration_init(const U8* pSetPropCmd)
{
  ...
  */
  ...
  while (*pSetPropCmd != 0x00)
  {
    ...
    /*Malyska: Radio interrup operation is not supported on the hardware used.
