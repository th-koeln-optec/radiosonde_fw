 ...
 * vX.XX    M. Malyska
 *      Changes where implemented by the author, the original file can be found in the same directory: si446x_api_lib.c.bak
 */
